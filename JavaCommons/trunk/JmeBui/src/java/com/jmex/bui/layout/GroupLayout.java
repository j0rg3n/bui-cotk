...
public abstract class GroupLayout extends BLayoutManager
{
	 ...
	 * A fixed component will not be stretched along the major axis of the
	 * group. Those components that are stretched will have the extra space
	 * divided among them according to their weight (specifically receiving the
	 * ratio of their weight to the total weight of all of the free components
	 * in the container).
	 * 
	 * <p/> If a constraints object is constructed with fixedness set to true
	 * and with a weight, the weight will be ignored.
	 */
	public static class Constraints
	{
		...
		/**
		 * The weight of this component relative to the other components in the
		 * container.
		 */
		public int weight = 1;

		/**
		 * Constructs a new constraints object with the specified fixedness and
		 * weight.
		 */
	...
	/**
	 * A constraints object that indicates that the component should be fixed
	 * and have the default weight of one. This is so commonly used that we
	 * create and make this object available here.
	 */
	...
	/**
	 * Stretch all the widgets to be equal to the size of the largest widget on
	 * this axis.
	 */
	public final static Policy EQUALIZE = new Policy(2);
	/**
	 * Only valid for off-axis policy, this leaves widgets alone unless they are
	 * larger in the off-axis direction than their container, in which case it
	 * constrains them to fit on the off-axis.
	 */
	...
	/**
	 * Computes dimensions of the children widgets that are useful for the group
	 * layout managers.
	 */
	...
	/**
	 * Convenience method for creating a horizontal group layout manager that
	...
	/**
	 * Convenience method for creating a vertical group layout manager that
	 * stretches in both directions.
	 */
