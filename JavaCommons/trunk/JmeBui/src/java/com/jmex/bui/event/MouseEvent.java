...
{
	private static final long serialVersionUID = -3869795977149786050L;
	...
	/**
	 * An event generated when the mouse is dragged. Drag events are dispatched
	 * to the component in which a mouse is clicked and held for all movement
	...
	public MouseEvent(Object source, long when, int modifiers, int type, int button, int mx, int my, int delta)
	{
	...
	/**
	 * Returns the type of this event, one of {@link #MOUSE_PRESSED}, {#link
	 * MOUSE_RELEASE}, etc.
	 */
	public int getType()
	{
	 ...
	 * #BUTTON1}, {@link #BUTTON2}, or {@link #BUTTON3}) or -1 if this is not
	 * a button related event.
	 */
	...
	/**
	 * Returns the (absolute) x coordinate of the mouse at the time this event
	 * was generated.
	 */
	public int getX()
	{
	...
	/**
	 * Returns the (absolute) y coordinate of the mouse at the time this event
	 * was generated.
	 */
	public int getY()
	{
	...
	/**
	 * For mouse wheel events this indicates the delta by which the wheel was
	 * moved. The units seem to be defined by the underlying OpenGL wrapper,
	 * presently LWJGL.
	 */
	public int getDelta()
	{
	...
	public void setTarget(BComponent target)
	{
		this.target = target;
	}
