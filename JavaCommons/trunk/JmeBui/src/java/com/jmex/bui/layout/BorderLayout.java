...
public class BorderLayout extends BLayoutManager
{
	...
	/**
	 * Creates a border layout with zero gap between the horizontal components
	 * and zero gap between the vertical.
	 */
	public BorderLayout()
	{
		this(0, 0);
	...
	/**
	 * Creates a border layout with the specified gap between the horizontal
	 * components and the specified gap between the vertical.
	 */
