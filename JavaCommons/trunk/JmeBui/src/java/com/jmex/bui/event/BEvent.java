...
{
	private static final long serialVersionUID = -7555027751480806332L;

	/**
	 * Returns the time at which this event was generated or -1 if this event
	 * was not a result of a user action with an associated timestamp.
	 */
	public long getWhen()
	{
		return _when;
	...
	/**
	 * Instructs this event to notify the supplied listener if they implement an
	 * interface appropriate to this event.
	 */
