...
/**
 * Bridges between the AWT and the BUI input event system when we are being used
 * in an AWT canvas.
 */
public class CanvasRootNode extends BRootNode implements java.awt.event.MouseListener, java.awt.event.MouseMotionListener, java.awt.event.MouseWheelListener, java.awt.event.KeyListener
{
	private static final long serialVersionUID = -5993596355222173332L;
	...
	public void mousePressed(java.awt.event.MouseEvent e)
	{
		...
		MouseEvent event = new MouseEvent(this, e.getWhen(), _modifiers, MouseEvent.MOUSE_PRESSED, convertButton(e), _mouseX, _mouseY);
	...
	{
		updateState(e);
		MouseEvent event = new MouseEvent(this, e.getWhen(), _modifiers, MouseEvent.MOUSE_RELEASED, convertButton(e), _mouseX, _mouseY);
	...
	public void mouseMoved(java.awt.event.MouseEvent e)
	{
		...
		if (mouseMoved)
		{
			...
			int type = (tcomponent != null && tcomponent == _ccomponent) ? MouseEvent.MOUSE_DRAGGED : MouseEvent.MOUSE_MOVED;
			MouseEvent event = new MouseEvent(this, e.getWhen(), _modifiers, type, _mouseX, _mouseY);
	...
	{
		updateState(e);
		MouseEvent event = new MouseEvent(this, e.getWhen(), _modifiers, MouseEvent.MOUSE_WHEELED, convertButton(e), _mouseX, _mouseY, e.getWheelRotation());
		dispatchEvent(getTargetComponent(), event);
	}
	...
	public void keyPressed(java.awt.event.KeyEvent e)
	{
		...
		KeyEvent event = new KeyEvent(this, e.getWhen(), _modifiers, KeyEvent.KEY_PRESSED, e.getKeyChar(), convertKeyCode(e));
		dispatchEvent(getTargetComponent(), event);
	}
	...
	public void keyReleased(java.awt.event.KeyEvent e)
	{
		// update our modifiers
		_modifiers = convertModifiers(e.getModifiers());
		KeyEvent event = new KeyEvent(this, e.getWhen(), _modifiers, KeyEvent.KEY_RELEASED, e.getKeyChar(), convertKeyCode(e));
		dispatchEvent(getTargetComponent(), event);
	}
	...
	protected int convertButton(java.awt.event.MouseEvent e)
	{
		...
		case 0:
			return -1; // this is generated when we wheel
		default:
			Log.log.warning("Requested to map unknown button '" + e.getButton() + "'.");
			return e.getButton();
		}
	}
	...
	protected int convertKeyCode(java.awt.event.KeyEvent e)
	{
		...
		case java.awt.event.KeyEvent.VK_EQUALS:
			return e.getKeyLocation() == java.awt.event.KeyEvent.KEY_LOCATION_NUMPAD ? KeyInput.KEY_NUMPADEQUALS : KeyInput.KEY_EQUALS;
		...
		case java.awt.event.KeyEvent.VK_ENTER:
			return e.getKeyLocation() == java.awt.event.KeyEvent.KEY_LOCATION_NUMPAD ? KeyInput.KEY_NUMPADENTER : KeyInput.KEY_RETURN;
		case java.awt.event.KeyEvent.VK_CONTROL:
			return e.getKeyLocation() == java.awt.event.KeyEvent.KEY_LOCATION_LEFT ? KeyInput.KEY_LCONTROL : KeyInput.KEY_RCONTROL;
		...
		case java.awt.event.KeyEvent.VK_SHIFT:
			return e.getKeyLocation() == java.awt.event.KeyEvent.KEY_LOCATION_LEFT ? KeyInput.KEY_LSHIFT : KeyInput.KEY_RSHIFT;
		...
		case java.awt.event.KeyEvent.VK_COMMA:
			return e.getKeyLocation() == java.awt.event.KeyEvent.KEY_LOCATION_NUMPAD ? KeyInput.KEY_NUMPADCOMMA : KeyInput.KEY_COMMA;
		...
		case java.awt.event.KeyEvent.VK_NUM_LOCK:
			return KeyInput.KEY_NUMLOCK;
		case java.awt.event.KeyEvent.VK_SCROLL_LOCK:
			return KeyInput.KEY_SCROLL;
		...
		case java.awt.event.KeyEvent.VK_KANA:
			return KeyInput.KEY_KANA;
		case java.awt.event.KeyEvent.VK_CONVERT:
			return KeyInput.KEY_CONVERT;
		...
		case java.awt.event.KeyEvent.VK_KANJI:
			return KeyInput.KEY_KANJI;
		case java.awt.event.KeyEvent.VK_STOP:
			return KeyInput.KEY_STOP;
