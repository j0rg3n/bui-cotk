...
public class DocumentUTest extends TestCase
{
	...
	public void testEdit()
	{
		...
		assertTrue("Check line: " + OUTPUT[lineidx], doc.getText().equals(OUTPUT[lineidx++]));
	...
	protected static final String[] OUTPUT = { "The quick brown fox jumped over the lazy dog.", "I heard that The quick brown fox jumped over the lazy dog.", "The quick brown fox jumped over the lazy dog.", "Some guy said, \"The quick brown fox jumped over the lazy dog.\"", "Some guy said, \"The quick brown fox jumped over the spritely dog.\"", };
}
