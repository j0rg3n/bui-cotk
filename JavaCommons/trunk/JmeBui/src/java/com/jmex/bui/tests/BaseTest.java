...
public abstract class BaseTest extends SimpleGame
{
	...
	protected void simpleInitGame()
	{
		...
		try
		{
			InputStream stin = getClass().getClassLoader().getResourceAsStream("rsrc/style.bss");
			style = new BStyleSheet(new InputStreamReader(stin), new BStyleSheet.DefaultResourceProvider());
		}
		catch (Exception e)
		{
