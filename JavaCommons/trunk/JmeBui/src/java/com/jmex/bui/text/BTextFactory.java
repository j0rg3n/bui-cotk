 ...
 */
public abstract class BTextFactory implements BConstants
{
	/**
	 ...
	 * this text factory and the foreground color specified.
	 */
	 ...
	 * 
	 * @param useAdvance
	 *            if true, the advance to the next insertion point will be
	 *            included in the bounds of the created text (this is needed by
	 *            editable text displays).
	 */
	public abstract BText createText(String text, ColorRGBA color, int effect, ColorRGBA effectColor, boolean useAdvance);
	 ...
	 * specified width.
	 */
	public abstract BText[] wrapText(String text, ColorRGBA color, int effect, ColorRGBA effectColor, int maxWidth);
}
