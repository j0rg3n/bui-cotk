...
public abstract class BLayoutManager
{
	 ...
	 * preferred sizes of its children and the layout policy implemented by this
	 * manager. <em>Note:</em> it is not necessary to add the container's
	 * insets to the returned preferred size.
	 */
	public abstract Dimension computePreferredSize(BContainer target, int whint, int hhint);
