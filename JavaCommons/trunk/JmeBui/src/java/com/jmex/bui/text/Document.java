...
public class Document
{
	...
	public interface Listener
	{
		 ...
		 * 
		 * @param document
		 *            the document into which text was inserted.
		 * @param offset
		 *            the offset into the document of the inserted text.
		 * @param length
		 ...
		 * 
		 * @param document
		 *            the document from which text was removed.
		 * @param offset
		 *            the offset into the document of the removed text.
		 * @param length
	...
	protected void notify(boolean inserted, int offset, int length)
	{
		if (_listeners != null)
		{
			...
			for (int ii = _listeners.size() - 1; ii >= 0; ii--)
			{
				...
				{
					Log.log.log(Level.WARNING, "Document listener choked on " + action + " [doc=" + this + ", offset=" + offset + ", length=" + length + ", listener=" + list + "].", t);
				}
			}
		}
	}
